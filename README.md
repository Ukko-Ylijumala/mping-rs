...
- Traceroute to a target (`T`) with PTR name and origin AS per hop, shown live in a popup
...
- [`traceroute.md`](doc/design/traceroute.md) — ICMP traceroute with per-hop AS annotation.
